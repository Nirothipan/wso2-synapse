    ...
    public static void builldMessage(MessageContext messageContext, boolean earlyBuild,
        ...
        try {
            ...
            if (element != null) {
                ...
                earlyBuild = messageContext.getProperty(PassThroughConstants.RELAY_EARLY_BUILD) != null ?
                        (Boolean) messageContext.getProperty(PassThroughConstants.RELAY_EARLY_BUILD) :
                        earlyBuild;
