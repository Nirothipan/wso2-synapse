...
public class Axis2SynapseEnvironment implements SynapseEnvironment {
     ...
     */
    private List<String> internalResourcePrefixList;
    ...
    public Axis2SynapseEnvironment(SynapseConfiguration synCfg) {
        ...
        this.internalResourcePrefixList = loadInternalResourcePrefixList();
    }
    ...
    private List<String> loadInternalResourcePrefixList() {

        String internalResources = SynapsePropertiesLoader.getPropertyValue(SynapseConstants.API_INTERNAL_RESOURCE_LIST,
                                                                            SynapseConstants.DEFAULT_API_INTERNAL_RESOURCE_LIST);
        String[] resourceList = internalResources.trim().split(SynapseConstants.STRING_SEPARATOR);
        List<String> internalResourceList = new ArrayList<String>();
        for (String resource : resourceList) {
            internalResourceList.add(resource.trim());
        }
        return internalResourceList;
    }
...
//                    inboundStatistics = inboundEndpoint.getAspectConfiguration().isStatisticsEnable();
    ...
    public List<String> getInternalResourcePrefixList() {
        return internalResourcePrefixList;
    }
}
